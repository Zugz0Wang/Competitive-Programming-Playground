...
public:
    vector<vector<string>> findDuplicate(vector<string>& paths) {
        ...
        // From https://leetcode.com/problems/find-duplicate-file-in-system/discuss/104123/C%2B%2B-clean-solution-answers-to-follow-up
        ...
        for (pair<string,vector<string>> file : files) {
